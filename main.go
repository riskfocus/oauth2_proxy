...
func main() {
	...
	flagSet.String("banned-emails-file", "", "ban emails listed in file (one per line)")
	...
	validator := NewValidator(opts.EmailDomains, opts.AuthenticatedEmailsFile, opts.BannedEmailsFile)
